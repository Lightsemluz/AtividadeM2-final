...
<html>
    ...
    <body>
            ...
            int livros =Integer.parseInt( request.getParameter("id_prod"));
            ...
            try{
                ...
                String sql = "INSERT INTO carrinho (id_cliente, id_livro) VALUES (?, ?)"; //defin instr. SQL
                PreparedStatement pstmt = conexao.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
                pstmt.setInt(1,cliente);
                pstmt.setInt(2,livros);
                pstmt.executeUpdate();
                conexao.close();            
            }
            catch(Exception ex){
